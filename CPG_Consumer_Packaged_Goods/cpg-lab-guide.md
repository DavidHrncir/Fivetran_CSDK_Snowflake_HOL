# Fivetran Connector SDK Hands on Lab with Snowflake 2025: Consumer Packaged Goods Insights
...
6. Configure your app:
   - App title: **[your initials]-InsightEdge**
   - Database: Select **HOL_DATABASE_1**
   - Schema: Select your schema which is the same name as your connector (example: dh0816cpg) the schema created by your Fivetran connector.
