...
3. Click on the **cpg** folder and then click on the `connector.py` file in that folder
...
MODELS = [
    "snowflake-llama-3.1-405b", "snowflake-llama-3.3-70b", "mistral-large2", "llama3.1-70b", 
    "llama4-maverick", "llama4-scout", "claude-3-5-sonnet", "llama3.1-8b", "deepseek-r1"
]
...
- API Connector Reference: [https://sdk-demo-api-dot-internal-sales.uc.r.appspot.com/cpg_api_spec](https://sdk-demo-api-dot-internal-sales.uc.r.appspot.com/cpg_api_spec)
