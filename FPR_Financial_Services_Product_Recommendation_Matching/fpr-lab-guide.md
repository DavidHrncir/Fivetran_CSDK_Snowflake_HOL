...
3. Click on the **fpr** folder and then click on the `connector.py` file in that folder
...
- API Connector Reference: [https://sdk-demo-api-dot-internal-sales.uc.r.appspot.com/fpr_api_spec](https://sdk-demo-api-dot-internal-sales.uc.r.appspot.com/fpr_api_spec)
