# Fivetran Connector SDK Hands on Lab with Snowflake 2025: Insurance Claims Processing
...
7. Copy all 5 values from the icp_manual.env file and paste them into your terminal and press enter/return.
...
6. Configure your app:
   - App title: **[your initials]-ClaimSphere**
   - Database: Select **HOL_DATABASE_1**
   - Schema: Select your schema which is the same name as your connector (example: dh0816icp) the schema created by your Fivetran connector.
