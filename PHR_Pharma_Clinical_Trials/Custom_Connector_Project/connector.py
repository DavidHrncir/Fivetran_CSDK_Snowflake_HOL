...
def schema(configuration: dict):
    """Define the minimal table schema for Fivetran. Fivetran will infer the schema from the data returned by the update function."""
    ...
    try:
        while has_more:
            ...
            if iteration_count > 200:
                log.warning("Reached maximum iteration limit (200). Saving checkpoint and exiting.")
