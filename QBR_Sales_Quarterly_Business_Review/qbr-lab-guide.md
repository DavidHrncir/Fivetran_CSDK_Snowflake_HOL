# Fivetran Connector SDK Hands on Lab at Snowflake Summit 2025: Quarterly Business Reviews for Sales
...
3. Click on the **qbr** folder and then click on the `connector.py` file in that folder
...
8. You'll see output displaying the results of the debug script including:
    ...
    - Verifies data loading and schema creation by simulating a full sync (in this case, upserting 755 records into qbr_records).
...
- API Connector Reference: [https://sdk-demo-api-dot-internal-sales.uc.r.appspot.com/qbr_api_spec](https://sdk-demo-api-dot-internal-sales.uc.r.appspot.com/qbr_api_spec)
